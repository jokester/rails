...
class SecurePasswordTest < ActiveModel::TestCase
  ...
  test 'create a new user with validation and password length greater than 72 single byte characters' do
    @user.password = 'a' * 73
  ...
  test 'updating an existing user with validation and password length greater than 72 bytes' do
